...
init -1 python hide:
    ...
    config.window_title = u"Wizards vs Scientists: A Chemystery"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Wizards vs Scientists: A Chemystery"
    config.version = "0.0"
    ...
    style.default.font = "Raleway-Medium.ttf"
    ...
    config.main_menu_music = "bensound-scifi.mp3"
...
python early:
    config.save_directory = "Wizards vs Scientists: A Chemystery-1435280971"
...
init python:
    ...
    build.directory_name = "wizards_vs_scientists_a_chemystery-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "wizards_vs_scientists_a_chemystery"
